...
- (void)loadNativeAd
{
  ...
  dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0), ^{
    [[HTFBAdDownloader sharedInstance]downloadFBAdWithPlacementId:@"404816499563670_1004933459551968" count:1 completeBlock:^(NSArray *ads) {
      NSLog(@"%@",ads);
    }];
  });
//
...
//  FBNativeAd *nativeAd = [[FBNativeAd alloc] initWithPlacementID:@"404816499563670_1004933459551968"];
//
